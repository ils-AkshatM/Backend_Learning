...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (!createdUser) {
    throw new ApiError(500, "Something went wrong while regisitring the user.");
  }
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //if we want to have the options for logging in from both of them emails and usernames
  // if(!(username || email)) {
  //   throw new ApiError(400, "User or Email is required")
  // }
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  // to add: delete the old existing image
